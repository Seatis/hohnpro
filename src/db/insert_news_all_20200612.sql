...
DELETE from hohnhu_angular.hohn_news;
...
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    ...
    '2020-01-30T10:00:00',
    '<p>Az országgyűlési képviselő véleménye a családon belüli erőszakról 2020.01.30.</p>
    ...
    'media',
    'assets/images/news/202001301000.jpg',
    'assets/images/news/202001301000.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/rTBuxDo4-sw',
    'Az országgyűlési képviselő véleménye a családon belüli erőszakról.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'A kormány miért hanyagolja el és zülleszti le az oktatást?',
    '2020-03-02T10:00:00',
    ...
    'assets/images/news/default.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/Y5Pai37j8No',
    'Hohn Krisztina napirend előtti felszólalása');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Székely autonómia',
    '2020-02-27T10:00:00',
    ...
    'assets/images/news/default.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/TNfK-a9Rtlk',
    'Segítsük egy aláírással a székely autonómia törekvésrő szóló kezdeményezést!');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'A fiatalkorúakat érintő emberkereskedelem',
    '2020-02-28T10:00:00',
    '<p>A fiatalkorúakat érintő emberkereskedelem Magyarországon is probléma.</p>',
    'parlament',
    'assets/images/news/default.jpg',
    'assets/images/news/default.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/7vqAR7s4QTg',
    'A fiatalkorúakat érintő emberkereskedelem Magyarországon is probléma.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Karantén intézkedések',
    '2020-04-03T10:00:00',
    '<p>Milyen intézkedéseket terveznek az önkéntes karantén alatti családon belüli erőszakkal szemben?</p>',
    'parlament',
    'assets/images/news/default.jpg',
    'assets/images/news/default.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/f1Y7bkk3YUg',
    'Milyen intézkedéseket terveznek az önkéntes karantén alatti családon belüli erőszakkal szemben?');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Kérdezzen kerek perc',
    '2020-04-21T10:00:00',
    '<p>Kérdezzen bátran, és én legjobb tudásom szerint válaszolok!</p>
    ...
    'hir',
    'assets/images/news/20200421/202004211000.jpg',
    'assets/images/news/20200421/202004211000_sec.jpg',
    'Hohn Krisztina',
    null,
    'Kérdezzen bátran, és én legjobb tudásom szerint válaszolok!');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Szegények és uzsorások',
    '2020-04-24T10:00:00',
    ...
    'Hohn Krisztina',
    'https://www.youtube.com/embed/cL-MSp7oobY',
    'Hogyan menti meg a szegényeket a kormány az uzsorásoktól járvány idején? Hohn Krisztina azonnali kérdése 2020. ápr. 20.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Orbán Viktor: nő ügyekkel nem foglalkozik!',
    '2020-05-04T10:00:00',
    '<p>A kormány egy elfogadhatatlan politikai nyilatkozatot terjesztett elő, amely elutasítja az isztambuli egyezményt.<br />
    ...
    'parlament',
    'assets/images/news/general/general_2.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/FsZ8Cx_aUSw',
    'Orbán Viktor: nő ügyekkel nem foglalkozik! Az isztambuli egyezmény elutasítása.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Maguknak ilyenkor ez jár az eszükben?',
    '2020-05-05T10:00:00',
    '<p>"Hogy-hogy, maguknak ilyenkor, amikor járvány van, ez jár az eszükben?"<br />
    ...
    'Hohn Krisztina',
    null,
    'Hogy-hogy, maguknak ilyenkor, amikor járvány van, ez jár az eszükben?, 2020. május 05.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Mi lesz a nehéz helyzetben élőkkel?',
    '2020-05-08T10:00:00',
    ...
    'hir',
    'assets/images/news/20200508/202005081000.jpg',
    'assets/images/news/20200508/202005081000_sec.jpg',
    'Hohn Krisztina',
    null,
    'Mi lesz a nehéz helyzetben élőkkel? Interjú Hohn Krisztinával, 2020. május 08.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'A szociális dolgozók is megkapják a megérdemelt 500 ezer forintot?',
    '2020-05-11T10:00:00',
    '<p>A szociális dolgozók is megkapják a megérdemelt 500 ezer forintot?</p>
      <p>Hohn Krisztina azonnali kérdése 2020.05.11.</p>',
    'parlament',
    'assets/images/news/general/general_2.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/osFPJKElNYE',
    'A szociális dolgozók is megkapják a megérdemelt 500 ezer forintot? Hohn Krisztina azonnali kérdése 2020.05.11.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Online sajtótájékoztató az örökbefogadásról',
    '2020-05-19T10:00:00',
    '<p>Az LMP frakció módosító javaslatot nyújt be a kötlelező felkészítő tanfolyam megtartásáért és költségének állami átvállalásáért.</p>',
    'sajtaj',
    'assets/images/news/general/general_2.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fhohnkrisztina%2Fvideos%2F1152971745056504%2F&show_text=0',
    'Az LMP frakció módosító javaslatot nyújt be a kötlelező felkészítő tanfolyam megtartásáért és költségének állami átvállalásáért.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Áprilisban 330 ezerre nőtt a munkanélküliek száma',
    '2020-05-20T10:00:00',
    '<p>Az ATV Start vendégei Hohn Krisztina országgyűlési képviselő, LMP és Burány Sándor frakcióvezető-helyettes, Párbeszéd.</p>
    ...
    'media',
    'assets/images/news/20200520/202005201000.jpg',
    'assets/images/news/20200520/202005201000_sec.jpg',
    'Hohn Krisztina',
    null,
    'Az ATV Start vendégei Hohn Krisztina országgyűlési képviselő, LMP és Burány Sándor frakcióvezető-helyettes, Párbeszéd.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Kell felkészítő tanfolyam az örökbefogadás előtt',
    '2020-05-20T14:00:00',
    '<p>Hohn Krisztina vezérszónoki felszólalása az örökbefogadásról szóló törvény vitájában.</p>',
    'parlament',
    'assets/images/news/general/general_1.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/XoHi9AbfCI8',
    'Hohn Krisztina vezérszónoki felszólalása az örökbefogadásról szóló törvény vitájában.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Az örökbefogadási tanfolyam fontosságáról',
    '2020-05-21T10:00:00',
    '<p>Hohn Krisztina (Új Kezdet elnök) kétperces felszólalása az örökbefogadásról szóló törvény vitájában.</p>',
    'parlament',
    'assets/images/news/general/general_2.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/syUP1-ZFM5g',
    'Hohn Krisztina (Új Kezdet elnök) kétperces felszólalása az örökbefogadásról szóló törvény vitájában.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'A kormány és a diplomások ára',
    '2020-05-21T14:00:00',
    '<p>Hohn Krisztina publicisztikája. Kattintson az alábbi linkre a megtekintéshez: </p>
    ...
    'hir',
    'assets/images/news/20200521/20200521.jpg',
    'assets/images/news/20200521/20200521_sec.jpg',
    'Hohn Krisztina',
    null,
...
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    ...
    'assets/images/news/general/general_sec_1.jpg',
    'Hohn Krisztina',
    'https://www.youtube.com/embed/r3dqMQLj51Y',
    'Hohn Krisztina napirend előtti felszólalása  2020. június 3.');
INSERT INTO hohnhu_angular.hohn_news(cim, szerzo, kategoria, kepMainUrl, kepSecUrl, videoUrl, datum, htmlContent, rovidLeiras) VALUES (
    'A trianoni békediktátum 100. évfordulója',
    'Új Kezdet',
    'hir',
    'assets/images/news/20200603/20200603.jpg',
    'assets/images/news/20200603/20200603_sec.jpg',
    null,
    '2020-06-03T14:00:00',
    ...
    'A trianoni békediktátum 100. évfordulója. 2020. június 4.');
INSERT INTO hohnhu_angular.hohn_news(cim, szerzo, kategoria, kepMainUrl, kepSecUrl, videoUrl, datum, htmlContent, rovidLeiras) VALUES (
    'Bot és bilincs az iskolaőröknél?',
    'Hohn Krisztina',
    'parlament',
    'assets/images/news/general/general_1.jpg',
    'assets/images/news/general/general_sec_1.jpg',
    'https://www.youtube.com/embed/5pnh0kOSt7M',
    '2020-06-10T10:00:00',
    '<p style="text-align: justify">Hohn Krisztina parlamenti felszólalása az iskolaőrökkel kapcsolatban.</p>',
    'Hohn Krisztina parlamenti felszólalása az iskolaőrökkel kapcsolatban.');
INSERT INTO hohnhu_angular.hohn_news(cim, datum, htmlContent, kategoria, kepMainUrl, kepSecUrl, szerzo, videoUrl, rovidLeiras) VALUES (
    'Változnak az örökbefogadás szabályai',
    '2020-06-12T10:00:00',
    '<p>Az ATV - Egyenes Besz&eacute;d vend&eacute;gei: Hohn Krisztina orsz&aacute;ggyűl&eacute;si k&eacute;pviselő, &eacute;s Bayer Friderika &eacute;nekesnő 2020.06.11.</p>',
    'media',
    'assets/images/news/20200612/20200612.jpg',
    'assets/images/news/20200612/20200612_sec.jpg',
    'Hohn Krisztina',
